...
<meta name="description" content="Admize, aiuta piccole e grandi aziende ad integrare con profitto il web nei propri processi di business per accrescerne la competitivit&agrave;, la produttivit&agrave; e definire nuovi scenari competitivi">
...
<div id="content" class="clearfix">
    ...
    <div class="mono path" >
        ...
        <p class="point2"><span><strong>2)</strong> </span>Rivediamo e sviluppiamo insieme, un nuovo <strong>Marketing Mix </strong>per i tuoi prodotti e servizi <strong>orientato al web</strong> ed al mercato digitale.<br>
            <a href="web-marketing/web-marketing.php" class="button_arrow">scopri di pi&ugrave;</a></small></p>
        <p class="point3"><span><strong>3)</strong> </span>Integriamo, trasferiamo e ti aiutiamo a <strong>gestire con successo </strong>e profitto <strong> il tuo Business online</strong>.<br>
            <a href="e-business/e-business.php" class="button_arrow">scopri di pi&ugrave;</a></small></p>
        <div class="slogan">
            <h2><strong>Admize </em></strong>&egrave; il tuo <strong>partner di riferimento</strong> per lo sviluppo di soluzioni<br>
    ...
    <div class="half">
        <div class="slidetabs" style="margin-top: 0px; background: url(images/bg_bridge.png) no-repeat 0 0; padding: 11px 60px; float: right;"></a> <a href="#"></a><a href="#"></a></div>
    </div>
